...
public class DeployServiceImplTest {
	...
	public void testGetInstallLog() {
		...
		System.out.println("参数列表:\n当前日志文件id是:"+id1+",开始行数startIndex是"
				+start1+",读取行数:"+num1+"\n文件属性:\n总行数:"+log1.getEndIndex()+",日志内容:"
		...
		System.out.println("参数列表:\n当前日志文件id是:"+id2+",开始行数startIndex是"
				+start2+",读取行数:"+num2+"\n文件属性:\n总行数:"+log2.getEndIndex()+",日志内容:"
		...
		System.out.println("参数列表:\n当前日志文件id是:"+id3+",开始行数startIndex是"
				+start3+",读取行数:"+num3+"\n文件属性:\n总行数:"+log3.getEndIndex()+",日志内容:"
		...
		System.out.println("参数列表:\n当前日志文件id是:"+id4+",开始行数startIndex是"
				+start4+",读取行数:"+num4+"\n文件属性:\n总行数:"+log4.getEndIndex()+",日志内容:"
		...
		System.out.println("参数列表:\n当前日志文件id是:"+id5+",开始行数startIndex是"
				+start5+",读取行数:"+num5+"\n文件属性:\n总行数:"+log5.getEndIndex()+",日志内容:"
		...
		System.out.println("参数列表:\n当前日志文件id是:"+id6+",开始行数startIndex是"
				+start6+",读取行数:"+num6+"\n文件属性:\n总行数:"+log6.getEndIndex()+",日志内容:"
